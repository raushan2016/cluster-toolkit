...
variable "enable_managed_lustre_csi" {
  description = "The status of the Google Compute Engine Managed Lustre Container Storage Interface (CSI) driver addon, which allows the usage of a lustre as volumes."
  type        = bool
  default     = false
}
